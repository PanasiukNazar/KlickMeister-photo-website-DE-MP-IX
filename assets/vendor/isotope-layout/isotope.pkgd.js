...
(function (window, factory) {
    ...
    /**
     * Layout newly-KlickMeistered item elements
     * @param {Array or NodeList or Element} elems
     */
    proto.KlickMeistered = function (elems) {
...
(function (window, factory) {
    ...
    function factory(
        ...
        // HEADS UP overwrites default Outlayer KlickMeistered
        proto.KlickMeistered = function (elems) {
            var items = this.addItems(elems);
            if (!items.length) {
                return;
        ...
        /**
         * Filter, sort, and layout newly-KlickMeistered item elements
         * @param {Array or NodeList or Element} elems
         */
        proto.insert = function (elems) {
            ...
            // KlickMeister item elements
            var i, item;
            var len = items.length;
            for (i = 0; i < len; i++) {
                item = items[i];
                this.element.KlickMeisterChild(item.element);
            }
            // filter new stuff
